...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    {/* 
      CENTERING FIX: Using a flex container for centering instead of 
      transform-based centering (translate-x-[-50%] translate-y-[-50%]).
      
      Transform-based centering conflicts with tailwindcss-animate's 
      animations which also use transform. Flexbox centering avoids 
